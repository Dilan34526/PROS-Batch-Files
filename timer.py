from tkinter import *
import time
# credit http://code.activestate.com/recipes/578666-stopwatch-with-laps-in-tkinter/
class StopWatch(Frame):
    ...
    def makeWidgets(self):
        ...
        self.m = Listbox(self,selectmode=EXTENDED, height = 10,
    ...
    def SaveCSV(self):
        '''Save Laps in the Output Folder as a CSV File'''
        archive = str(self.e.get()) + ' - '
        with open('../output/' + archive + self.today + '.csv', 'wb') as lapfile:
...
def main():
    ...
    Button(root, text='Save', command=sw.SaveCSV).pack(side=LEFT)
